      ...
      >
        <div className={styles.visualArea}>
          <div className={styles.visualStage}>
              ...
              <div className={styles.pcPreview}>
                ...
                <div className={styles.pcImageWrap}>
                  <Image
                    ...
                    alt={t("imageAlt.pc", { title: activeWork.title })}
                    fill
            ...
            <div className={styles.spPreview}>
              <div className={styles.spSpeaker} />

              <div className={styles.spImageWrap}>
                <Image
                  src={activeWork.spImage}
                  alt={t("imageAlt.sp", { title: activeWork.title })}
                  fill
                  sizes="160px"
                  className={styles.previewImage}
                  priority
        ...
        <div className={styles.contentArea}>
          <div className={styles.titleBlock}>
            <p className={styles.category}>{activeWork.category}</p>
            <h2>{activeWork.title}</h2>
            <p className={styles.summary}>{activeWork.summary}</p>
          </div>
          ...
          <div className={styles.sectionBlock}>
            ...
            <div className={styles.techGrid}>
              {techLabels.map((tech) => {
                ...
                return (
                  <div className={styles.techCard} key={tech.key}>
                    <h4>
                      <Icon />
          ...
          <p className={styles.prText}>{activeWork.pr}</p>
          ...
          {activeWork.url ? (
            ...
            <span className={styles.noLink}>{t("labels.noLink")}</span>
          )}
        </div>
      </article>
    </div>
